<template>
  <smart-action class="iam-add-member-wrapper">
    <render-horizontal-block :label-width="0">
              ...
              >
                <bk-dropdown-menu align="left" ref="dropdown" trigger="click">
                  ...
                  <ul class="bk-dropdown-list" slot="dropdown-content">
                    <li v-for="item in searchConditionList" :key="item.id" @click.stop="handleConditionSelected(item)">
      ...
      async handleSearchOrgAndUser () {
        ...
        for (let i = 0; i < manualInputValue.length; i++) {
          ...
          try {
            ...
            this.exactSearchList.push(manualInputValue[i]);
          } catch (e) {
            console.error(e);
